...
- **`public/`** — images (the five "Our approach" pillar renders `gem-structure.png` … `gem-stewardship.png`, `logo.svg`), hero video (`videos/hero_stratum_*`), favicon.
